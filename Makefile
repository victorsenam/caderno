...
TEST_NAMES = /math/fft /geometry_vec_ll /geometry_vec_double
...
$(TEST_DIR)/geometry_vec_double.o : $(TEST_DIR)/geometry_vec_double.cpp $(CODE_DIR)/geometry.cpp $(GTEST_HEADERS)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c $< -o $@
